...
- [ ] Scenario: Test cross-checks Makefile flags against CLI argparse
...
- [ ] Scenario: Test fails if a flag the Makefile passes is no longer accepted by CLI
...
- [ ] Scenario: Test runs as part of the standard test suite
